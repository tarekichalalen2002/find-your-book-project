...
const LoginForm = () => {
    ...
    useEffect(() => {
        if(state.user){
            navigate(`/users/${state.user.userId}/home`);
        }
    },[])
    ...
    const login = async (values , onSubmitProps) => {
        ...
        if (loggedInResponse.status === 201){
            ...
            navigate(`/users/${loggedIn.user.userId}/home`)
        }
        else{
            ...
            {({
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    >
                        ...
                        >
                            Dont't have an account ? <a href="/register" className="text-blue-600 underline hover:text-blue-700">Register here.</a>
                        </h1>
                        <h1
                        className={`text-center`}
                        onClick={() => {
                        ...
                        >
                            Are You The Admin ? <a href="/admin" className="text-blue-600 underline hover:text-blue-700">Click here.</a>
                        </h1>
                    </div>
                </form>
            )}
